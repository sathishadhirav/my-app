...
final class DotNetToJavaStringHelper {
  ...
  public static String substring(String string, int start, int length) {
    if (length < 0) throw new IndexOutOfBoundsException("Parameter length cannot be negative.");
  ...
  public static String join(String separator, String[] stringArray) {
    ...
    else return join(separator, stringArray, 0, stringArray.length);
  }
  ...
  public static String join(String separator, String[] stringArray, int startIndex, int count) {
    ...
    for (int index = startIndex;
        ...
        index++) {
      if (separator != null && index > startIndex) result += separator;

      if (stringArray[index] != null) result += stringArray[index];
    }
  ...
  public static String trimEnd(String string, Character... charsToTrim) {
    if (string == null || charsToTrim == null) return string;
  ...
  public static int lastIndexOf(String string, char value, int startIndex, int count) {
    ...
    if (lastIndexInSubstring < 0) return -1;
    else return lastIndexInSubstring + leftMost;
  }
  ...
  public static int indexOfAny(String string, char[] anyOf, int startIndex) {
    ...
    if (indexInSubstring == -1) return -1;
    else return indexInSubstring + startIndex;
  }
  ...
  public static int lastIndexOfAny(String string, char[] anyOf, int startIndex) {
    ...
    if (lastIndexInSubstring < 0) return -1;
    else return lastIndexInSubstring;
  }
