...
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void FF(ref uint a, uint b, uint c, uint d, uint x, int s, uint ac)
//	private static void FF(io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> a, int b, int c, int d, int x, int s, int ac)
//	{
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//	}
//	//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void GG(ref uint a, uint b, uint c, uint d, uint x, int s, uint ac)
//	private static void GG(io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> a, int b, int c, int d, int x, int s, int ac)
//	{
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//	}
//	//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void HH(ref uint a, uint b, uint c, uint d, uint x, int s, uint ac)
//	private static void HH(io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> a, int b, int c, int d, int x, int s, int ac)
//	{
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//	}
//	//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void II(ref uint a, uint b, uint c, uint d, uint x, int s, uint ac)
//	private static void II(io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> a, int b, int c, int d, int x, int s, int ac)
//	{
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//	   context. */
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void MD5Update(MD5_CTX context, byte[] input, uint inputIndex, uint inputLen)
//	private static void MD5Update(MD5_CTX context, byte[] input, int inputIndex, int inputLen) // length of input block -  Starting index for input block -  input block -  context
//	{
...
//
//		/* Round 1 */
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref a, b, c, d, x[0], S11, 0xd76aa478);
//		FF(tempRef_a, b, c, d, x[0], S11, 0xd76aa478); // 1
//		a = tempRef_a.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref d, a, b, c, x[1], S12, 0xe8c7b756);
//		FF(tempRef_d, a, b, c, x[1], S12, 0xe8c7b756); // 2
//		d = tempRef_d.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref c, d, a, b, x[2], S13, 0x242070db);
//		FF(tempRef_c, d, a, b, x[2], S13, 0x242070db); // 3
//		c = tempRef_c.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref b, c, d, a, x[3], S14, 0xc1bdceee);
//		FF(tempRef_b, c, d, a, x[3], S14, 0xc1bdceee); // 4
//		b = tempRef_b.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a2 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref a, b, c, d, x[4], S11, 0xf57c0faf);
//		FF(tempRef_a2, b, c, d, x[4], S11, 0xf57c0faf); // 5
//		a = tempRef_a2.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d2 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref d, a, b, c, x[5], S12, 0x4787c62a);
//		FF(tempRef_d2, a, b, c, x[5], S12, 0x4787c62a); // 6
//		d = tempRef_d2.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c2 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref c, d, a, b, x[6], S13, 0xa8304613);
//		FF(tempRef_c2, d, a, b, x[6], S13, 0xa8304613); // 7
//		c = tempRef_c2.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b2 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref b, c, d, a, x[7], S14, 0xfd469501);
//		FF(tempRef_b2, c, d, a, x[7], S14, 0xfd469501); // 8
//		b = tempRef_b2.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a3 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref a, b, c, d, x[8], S11, 0x698098d8);
//		FF(tempRef_a3, b, c, d, x[8], S11, 0x698098d8); // 9
//		a = tempRef_a3.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d3 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref d, a, b, c, x[9], S12, 0x8b44f7af);
//		FF(tempRef_d3, a, b, c, x[9], S12, 0x8b44f7af); // 10
//		d = tempRef_d3.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c3 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref c, d, a, b, x[10], S13, 0xffff5bb1);
//		FF(tempRef_c3, d, a, b, x[10], S13, 0xffff5bb1); // 11
//		c = tempRef_c3.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b3 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref b, c, d, a, x[11], S14, 0x895cd7be);
//		FF(tempRef_b3, c, d, a, x[11], S14, 0x895cd7be); // 12
//		b = tempRef_b3.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a4 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref a, b, c, d, x[12], S11, 0x6b901122);
//		FF(tempRef_a4, b, c, d, x[12], S11, 0x6b901122); // 13
//		a = tempRef_a4.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d4 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref d, a, b, c, x[13], S12, 0xfd987193);
//		FF(tempRef_d4, a, b, c, x[13], S12, 0xfd987193); // 14
//		d = tempRef_d4.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c4 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: FF(ref c, d, a, b, x[14], S13, 0xa679438e);
//		FF(tempRef_c4, d, a, b, x[14], S13, 0xa679438e); // 15
//		c = tempRef_c4.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b4 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//
//		/* Round 2 */
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a5 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref a, b, c, d, x[1], S21, 0xf61e2562);
//		GG(tempRef_a5, b, c, d, x[1], S21, 0xf61e2562); // 17
//		a = tempRef_a5.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d5 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref d, a, b, c, x[6], S22, 0xc040b340);
//		GG(tempRef_d5, a, b, c, x[6], S22, 0xc040b340); // 18
//		d = tempRef_d5.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c5 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref c, d, a, b, x[11], S23, 0x265e5a51);
//		GG(tempRef_c5, d, a, b, x[11], S23, 0x265e5a51); // 19
//		c = tempRef_c5.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b5 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref b, c, d, a, x[0], S24, 0xe9b6c7aa);
//		GG(tempRef_b5, c, d, a, x[0], S24, 0xe9b6c7aa); // 20
//		b = tempRef_b5.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a6 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref a, b, c, d, x[5], S21, 0xd62f105d);
//		GG(tempRef_a6, b, c, d, x[5], S21, 0xd62f105d); // 21
//		a = tempRef_a6.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d6 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref d, a, b, c, x[10], S22, 0x02441453);
//		GG(tempRef_d6, a, b, c, x[10], S22, 0x02441453); // 22
//		d = tempRef_d6.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c6 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref c, d, a, b, x[15], S23, 0xd8a1e681);
//		GG(tempRef_c6, d, a, b, x[15], S23, 0xd8a1e681); // 23
//		c = tempRef_c6.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b6 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref b, c, d, a, x[4], S24, 0xe7d3fbc8);
//		GG(tempRef_b6, c, d, a, x[4], S24, 0xe7d3fbc8); // 24
//		b = tempRef_b6.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a7 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref a, b, c, d, x[9], S21, 0x21e1cde6);
//		GG(tempRef_a7, b, c, d, x[9], S21, 0x21e1cde6); // 25
//		a = tempRef_a7.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d7 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref d, a, b, c, x[14], S22, 0xc33707d6);
//		GG(tempRef_d7, a, b, c, x[14], S22, 0xc33707d6); // 26
//		d = tempRef_d7.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c7 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref c, d, a, b, x[3], S23, 0xf4d50d87);
//		GG(tempRef_c7, d, a, b, x[3], S23, 0xf4d50d87); // 27
//		c = tempRef_c7.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b7 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref b, c, d, a, x[8], S24, 0x455a14ed);
//		GG(tempRef_b7, c, d, a, x[8], S24, 0x455a14ed); // 28
//		b = tempRef_b7.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a8 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref a, b, c, d, x[13], S21, 0xa9e3e905);
//		GG(tempRef_a8, b, c, d, x[13], S21, 0xa9e3e905); // 29
//		a = tempRef_a8.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d8 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref d, a, b, c, x[2], S22, 0xfcefa3f8);
//		GG(tempRef_d8, a, b, c, x[2], S22, 0xfcefa3f8); // 30
//		d = tempRef_d8.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c8 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: GG(ref c, d, a, b, x[7], S23, 0x676f02d9);
//		GG(tempRef_c8, d, a, b, x[7], S23, 0x676f02d9); // 31
//		c = tempRef_c8.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b8 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//
//		/* Round 3 */
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a9 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref a, b, c, d, x[5], S31, 0xfffa3942);
//		HH(tempRef_a9, b, c, d, x[5], S31, 0xfffa3942); // 33
//		a = tempRef_a9.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d9 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref d, a, b, c, x[8], S32, 0x8771f681);
//		HH(tempRef_d9, a, b, c, x[8], S32, 0x8771f681); // 34
//		d = tempRef_d9.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c9 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref c, d, a, b, x[11], S33, 0x6d9d6122);
//		HH(tempRef_c9, d, a, b, x[11], S33, 0x6d9d6122); // 35
//		c = tempRef_c9.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b9 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref b, c, d, a, x[14], S34, 0xfde5380c);
//		HH(tempRef_b9, c, d, a, x[14], S34, 0xfde5380c); // 36
//		b = tempRef_b9.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a10 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref a, b, c, d, x[1], S31, 0xa4beea44);
//		HH(tempRef_a10, b, c, d, x[1], S31, 0xa4beea44); // 37
//		a = tempRef_a10.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d10 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref d, a, b, c, x[4], S32, 0x4bdecfa9);
//		HH(tempRef_d10, a, b, c, x[4], S32, 0x4bdecfa9); // 38
//		d = tempRef_d10.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c10 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref c, d, a, b, x[7], S33, 0xf6bb4b60);
//		HH(tempRef_c10, d, a, b, x[7], S33, 0xf6bb4b60); // 39
//		c = tempRef_c10.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b10 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref b, c, d, a, x[10], S34, 0xbebfbc70);
//		HH(tempRef_b10, c, d, a, x[10], S34, 0xbebfbc70); // 40
//		b = tempRef_b10.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a11 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref a, b, c, d, x[13], S31, 0x289b7ec6);
//		HH(tempRef_a11, b, c, d, x[13], S31, 0x289b7ec6); // 41
//		a = tempRef_a11.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d11 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref d, a, b, c, x[0], S32, 0xeaa127fa);
//		HH(tempRef_d11, a, b, c, x[0], S32, 0xeaa127fa); // 42
//		d = tempRef_d11.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c11 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref c, d, a, b, x[3], S33, 0xd4ef3085);
//		HH(tempRef_c11, d, a, b, x[3], S33, 0xd4ef3085); // 43
//		c = tempRef_c11.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b11 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref b, c, d, a, x[6], S34, 0x04881d05);
//		HH(tempRef_b11, c, d, a, x[6], S34, 0x04881d05); // 44
//		b = tempRef_b11.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a12 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref a, b, c, d, x[9], S31, 0xd9d4d039);
//		HH(tempRef_a12, b, c, d, x[9], S31, 0xd9d4d039); // 45
//		a = tempRef_a12.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d12 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref d, a, b, c, x[12], S32, 0xe6db99e5);
//		HH(tempRef_d12, a, b, c, x[12], S32, 0xe6db99e5); // 46
//		d = tempRef_d12.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c12 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: HH(ref c, d, a, b, x[15], S33, 0x1fa27cf8);
//		HH(tempRef_c12, d, a, b, x[15], S33, 0x1fa27cf8); // 47
//		c = tempRef_c12.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b12 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//
//		/* Round 4 */
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a13 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref a, b, c, d, x[0], S41, 0xf4292244);
//		II(tempRef_a13, b, c, d, x[0], S41, 0xf4292244); // 49
//		a = tempRef_a13.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d13 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref d, a, b, c, x[7], S42, 0x432aff97);
//		II(tempRef_d13, a, b, c, x[7], S42, 0x432aff97); // 50
//		d = tempRef_d13.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c13 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref c, d, a, b, x[14], S43, 0xab9423a7);
//		II(tempRef_c13, d, a, b, x[14], S43, 0xab9423a7); // 51
//		c = tempRef_c13.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b13 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref b, c, d, a, x[5], S44, 0xfc93a039);
//		II(tempRef_b13, c, d, a, x[5], S44, 0xfc93a039); // 52
//		b = tempRef_b13.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a14 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref a, b, c, d, x[12], S41, 0x655b59c3);
//		II(tempRef_a14, b, c, d, x[12], S41, 0x655b59c3); // 53
//		a = tempRef_a14.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d14 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref d, a, b, c, x[3], S42, 0x8f0ccc92);
//		II(tempRef_d14, a, b, c, x[3], S42, 0x8f0ccc92); // 54
//		d = tempRef_d14.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c14 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref c, d, a, b, x[10], S43, 0xffeff47d);
//		II(tempRef_c14, d, a, b, x[10], S43, 0xffeff47d); // 55
//		c = tempRef_c14.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b14 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref b, c, d, a, x[1], S44, 0x85845dd1);
//		II(tempRef_b14, c, d, a, x[1], S44, 0x85845dd1); // 56
//		b = tempRef_b14.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a15 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref a, b, c, d, x[8], S41, 0x6fa87e4f);
//		II(tempRef_a15, b, c, d, x[8], S41, 0x6fa87e4f); // 57
//		a = tempRef_a15.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d15 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref d, a, b, c, x[15], S42, 0xfe2ce6e0);
//		II(tempRef_d15, a, b, c, x[15], S42, 0xfe2ce6e0); // 58
//		d = tempRef_d15.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c15 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref c, d, a, b, x[6], S43, 0xa3014314);
//		II(tempRef_c15, d, a, b, x[6], S43, 0xa3014314); // 59
//		c = tempRef_c15.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b15 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref b, c, d, a, x[13], S44, 0x4e0811a1);
//		II(tempRef_b15, c, d, a, x[13], S44, 0x4e0811a1); // 60
//		b = tempRef_b15.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_a16 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(a);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref a, b, c, d, x[4], S41, 0xf7537e82);
//		II(tempRef_a16, b, c, d, x[4], S41, 0xf7537e82); // 61
//		a = tempRef_a16.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_d16 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(d);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref d, a, b, c, x[11], S42, 0xbd3af235);
//		II(tempRef_d16, a, b, c, x[11], S42, 0xbd3af235); // 62
//		d = tempRef_d16.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_c16 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(c);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: II(ref c, d, a, b, x[2], S43, 0x2ad7d2bb);
//		II(tempRef_c16, d, a, b, x[2], S43, 0x2ad7d2bb); // 63
//		c = tempRef_c16.argValue;
//		io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer> tempRef_b16 = new io.quantum.trading.brokers.forex.mt5protocol.mtapi.mt5.RefObject<Integer>(b);
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//	   a multiple of 4. */
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: private static void Decode(uint[] output, byte[] input, uint inputIndex, uint len)
...
//		{
////C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
////ORIGINAL LINE: output[i] = ((uint)input[inputIndex + j]) | (((uint)input[inputIndex + j + 1]) << 8) | (((uint)input[inputIndex + j + 2]) << 16) | (((uint)input[inputIndex + j + 3]) << 24);
//			output[i] = ((int)input[inputIndex + j]) | (((int)input[inputIndex + j + 1]) << 8) | (((int)input[inputIndex + j + 2]) << 16) | (((int)input[inputIndex + j + 3]) << 24);
//		}
//	}
//}