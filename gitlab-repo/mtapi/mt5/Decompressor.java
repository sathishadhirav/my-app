...
class Decompressor
{
    ...
    private static void memcpyDs(String8[] dest_U, String8[] src_U, long[] len_U) {
        do {
            (dest_U[0] = String8.nnc(dest_U[0]).shift(1)).set(-1, (src_U[0] = nnc(src_U[0]).shift(1)).get(-1));
                ...
                for(;; pos = 0) switch(pos) {
                    default:
                        ...
                        if(t_U[0] == 0) {
                            ...
                            t_U[0] = t_U[0] + (15 + Byte.toUnsignedInt((ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1)));
                        }
                        ...
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1));
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1));
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1));
                        memcpyDs(op_U, ip_U, t_U);
                    case posFirstLiteralRun:
                        ...
                        mPos_U[0] = nnc(mPos_U[0]).shift(-(Byte.toUnsignedInt((ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1)) << 2));
                        ...
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (mPos_U[0] = nnc(mPos_U[0]).shift(1)).get(-1));
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (mPos_U[0] = nnc(mPos_U[0]).shift(1)).get(-1));
                        (op_U[0] = nnc(op_U[0]).shift(1)).set(-1, (mPos_U[0] = nnc(mPos_U[0]).shift(1)).get(-1));
                        pos = posMatchDone;
                        continue positionLoop;
                        ...
                        for(;; pos = 0) switch(pos) {
                            default:
                                if(Long.compareUnsigned(t_U[0], 64) >= 0) {
                                    ...
                                    mPos_U[0] = nnc(mPos_U[0]).shift(-(Byte.toUnsignedInt((ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1)) << 3));
                                    t_U[0] = (t_U[0] >>> 5) - 1;
                                    pos = posCopyMatch;
                                    continue positionLoop;
                                    ...
                                    if(t_U[0] == 0) {
                                        ...
                                        t_U[0] = t_U[0] + (31 + Byte.toUnsignedInt((ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1)));
                                    }
                                    mPos_U[0] = nnc(op_U[0]).shift(-1);
                                    mPos_U[0] = nnc(mPos_U[0]).shift(-((Byte.toUnsignedInt(ip_U[0].get(0)) >> 2) + (Byte.toUnsignedInt(ip_U[0].get(1)) << 6)));
                                    ...
                                    if(t_U[0] == 0) {
                                        ...
                                        t_U[0] = t_U[0] + (7 + Byte.toUnsignedInt((ip_U[0] = nnc(ip_U[0]).shift(1)).get(-1)));
                                    }
                                    mPos_U[0] = nnc(mPos_U[0]).shift(-((Byte.toUnsignedInt(ip_U[0].get(0)) >> 2) + (Byte.toUnsignedInt(ip_U[0].get(1)) << 6)));
                                    ip_U[0] = nnc(ip_U[0]).shift(2);
